...
curl_setopt($curl, CURLOPT_URL, "https://www.pcservice.com.uy/rest/products/bydate/?from=".date( "YmdHis", strtotime( "$fecha -24 hour")),);
    ...
    if($count == 0){
        ...
        if(isset($datas['images'])){
            ...
            foreach($imgs as $img){
                ...
                if(filesize($imga) > 0){
                    $imagenes [] = ["src" => "https://shopit.uy/wp-content/uploads/cdrimgs/$id.jpg?_t=1668833276"];
                }
            }
        }
